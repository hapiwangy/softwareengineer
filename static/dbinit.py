...
if __name__ == '__main__':
    ...
    cur = con.cursor()
    cur.execute("INSERT INTO users VALUES('happy', 'happy123', 'happy123', 1)")
    cur.execute("INSERT INTO users VALUES('tom', 'tom123', 'tom123',1)")
    cur.execute("INSERT INTO users VALUES('happy', 'kevin123', 'kevin123', 0)")
    cur.execute("INSERT INTO users VALUES('tom', 'sherry123', 'sherry123', 0)")
